...
public class Web_5_PantaloonsHomepage_mac_Firefox 
{
	WebDriver driver;
	...
	Web_5_PantaloonsHomepage_mac_Firefox PHpage;


		@BeforeClass
		public void driverinitiation() throws InterruptedException, MalformedURLException
		{
			String seleniumHubUrl = "https://cloud.fireflink.com/backend/fireflinkcloud/wd/hub?accessKey=a31168ce-bf67-4a7a-bfa1-997fca75f65a&licenseId=LIC1026534&projectName=Project+menu/";
