...
//		IOSDriver driver = new IOSDriver(new URL(seleniumHubUrl), caps);
		...
		String seleniumHubUrl = "https://fireflinkcloudtest.fireflink.com/backend/fireflinkcloud/wd/hub?accessKey=7ce369c5-0212-4258-840f-c3d79d03070b&licenseId=LIC3943&projectName=project+2/";
		DesiredCapabilities caps = new DesiredCapabilities();
		caps.setCapability("appium:deviceName", "iPhone 11");
		caps.setCapability("appium:platformName", "iOS");
...
//		caps.setCapability("app", "Myntra 4.2411.20.ipa");
//		caps.setCapability("bundleId", "com.myntra.myntra");//Pls change the bundleId value to proper value.
//		caps.setCapability("autoGrantPermissions", true);
//		caps.setCapability("autoGrantPermissions", true);
	...
	public void Steps(String productName) {
	    var searchBar = driver.findElement(By.xpath("(//XCUIElementTypeOther[@name=\"HPSearchBar\"])[2]"));
	    searchBar.click();
	    searchBar.sendKeys(productName);
	    
	    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
	    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//XCUIElementTypeOther[@name='leftElement'])[4]")));
	}
