...
public class Web_4_BMWHomePage2 
{
...
BMW_LandingPage bmw_LandingPage;
	...
	{
		//dev envi:
//		String seleniumHubUrl = "https://fireflinkclouddev.fireflink.com/backend/fireflinkcloud/wd/hub?accessKey=4f6f3903-4b38-43e3-9c29-38f5b66d8cb8&licenseId=LIC4630&projectName=check/";
...
//		driver.manage().window().setSize(new Dimension(1024, 768));
		...
		String seleniumHubUrl = "https://cloud.fireflink.com/backend/fireflinkcloud/wd/hub?accessKey=a31168ce-bf67-4a7a-bfa1-997fca75f65a&licenseId=LIC1026534&projectName=infraSupport/";
...
//		driver.manage().window().setSize(new Dimension(1024, 768));
	...
	public void LaunchHomePage(String time) throws InterruptedException, IOException
	{
		  ...
		  SessionId sessionId = driver.getSessionId();
	        ...
	        String query = String.format(
	            "{\"query\": \"{ session(id: \\\"%s\\\") { nodeUri } }\"}", sessionId
	        );

	        HttpClient client = HttpClient.newHttpClient();
	        HttpRequest request = HttpRequest.newBuilder()
	            .uri(URI.create("http://your-hub:4444/graphql"))
