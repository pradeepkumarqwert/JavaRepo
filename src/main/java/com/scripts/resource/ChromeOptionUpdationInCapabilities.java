...
public class ChromeOptionUpdationInCapabilities {
    ...
    public void initializationApp() throws MalformedURLException {
        ...
        options.setDeviceName("Samsung Galaxy A12");  // your real/emulator device
        options.setPlatformName("Android");
        options.setPlatformVersion("12");
        options.setAutomationName("UiAutomator2");
        options.setApp("General-Store-final (4).apk");
